...
paper-based) and eventually high fidelity ones somewhere after January (high fidelity prototypes were actual versions
of the app that would have mocked functionality if it wasn't implemented already).
...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.08]{paper_prototype}
