...
In terms of issues and bug tracking, we have kept a custom database on GitHub in order to be always up-to-date with what
is going on and where we lack quality and efficiency. We have made use of the custom labels GitHub already provides,
