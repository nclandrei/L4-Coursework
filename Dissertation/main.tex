...
between two nodes~\cite{dijkstra-shortest-path}, first published almost 60 years ago (the pseudocode was formally
...
Also, an issue with using any of the 3 options (W3 DOM Animation, Jquery animate or Velocity) was that they are
...
parameter as it is
inherited from the parent setTimeout; thus, in the inner setTimeout, setTimeout({...}, 3000 + $x$) becomes
setTimeout({...}, $x$)), the timings would not overlap
