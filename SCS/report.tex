...
\par
One such example is how NASA used SPIN the Model Checker to implement autonomous planning systems. In their case, such a system would decide what a rover or spacecraft should perform next (\citet{nasa-spin}). 
